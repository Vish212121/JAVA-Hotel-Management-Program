...
public class dessert extends Loading
{
    ...
    void Desserts()throws IOException, InterruptedException 
    {
        ...
        o.fp("\tMenu\t\t\t\t\tPrices");
        o.sp("\t1.Mixed Berry Mousse\t\t\tRs.130/-");
        o.sp("\t2.Mango Coconut Souffle\t\t\tRs.100/-");
        o.sp("\t3.Brownie with Vanilla Ice Cream\tRs.125/-");
        o.sp("\t4.Cheese Cake\t\t\t\tRs.145/-");
        o.sp("\t5.Chocolate-Mint Bars\t\t\tRs.135/-");
        o.sp("\t6.Raspberry-Rhubarb Pie\t\t\tRs.155/-");
        o.sp("\t7.Classic Fudge-Walnut Brownies\t\tRs.165/-");
        o.sp("\t8.Caramel Ice Cream\t\t\tRs.155/-");
        o.sp("\t9.Peanut Butter Pie\t\t\tRs.160/-");
        o.sp("\t10.Butterscotch Mousse Cake\t\tRs.199/-");
        o.sp("\t11.Choco Lava Cake\t\t\tRs.175/-");
        o.sp("\t12.Brownie Fantasy\t\t\tRs.170/-");
        o.sp("\t13.Ice Cream Cookie\t\t\tRs.175/-");
        o.sp("\t14.Caramel Brownie\t\t\tRs.180/-");
        o.sp("\t15.Waffles\t\t\t\tRs.199/-");
